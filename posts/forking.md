[category]: <> (General)
[date]: <> (2020/06/23)
[title]: <> (Hard Forks, Soft Forks, Defaults and Coerciont)
...
![img](http://vitalik.ca/files/posts_files/forks-and-markets-files/venn.png)
...
![img](http://vitalik.ca/files/posts_files/forks-and-markets-files/4RqDn4J.png)
...
Article originally published on [vitalik.ca](https://vitalik.ca/general/2017/03/14/forks_and_markets.html). Hosting here with WTFPL permission.
